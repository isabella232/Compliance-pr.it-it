...
- **Incidente di sicurezza**: un accesso illecito o non autorizzato ai dati del cliente o ai dati di supporto archiviati nei dispositivi o nelle strutture Microsoft che ha provocato la perdita, la divulgazione o l'alterazione dei dati del cliente o dei dati di supporto.
...
Il team di Microsoft Azure o Azure per enti pubblici può anche decidere di informare altri membri del personale Microsoft, ad esempio membri del team di supporto tecnico clienti (CSS) e l'Account Manager del cliente (AM) o il Technical Account Manager (TAM). Tali figure hanno spesso strette relazioni con il cliente e possono facilitare una correzione più rapida.
