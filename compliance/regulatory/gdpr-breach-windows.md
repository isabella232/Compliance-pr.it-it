...
Il team per il servizio di trattamento dei dati di Windows Enterprise può anche decidere di inviare altre informazioni al personale Microsoft, ad esempio al servizio clienti, agli Account Manager del cliente o al Responsabile account tecnici. Tali figure hanno spesso strette relazioni con il cliente e possono facilitare una correzione più rapida.
